...
export const PopularCategoryItem = (props) => {
    ...
    return (
        ...
        <Item onMouseEnter={() => {
            ...
            {hover && (
                <HoverCategoryItem textForTitle={textForTitle} textForSubtitle={textForSubtitle}
                                   backGround={backGround}/>

            )}

            {!hover && (
                <StaticCategoryItem textForTitle={textForTitle} textForSubtitle={textForSubtitle}
                                    backGround={backGround}/>
